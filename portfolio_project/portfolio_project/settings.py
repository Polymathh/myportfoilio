...
MPESA_TRANSACTION_TYPE = config("MPESA_TRANSACTION_TYPE", default="CustomerPayBillOnline").strip()
MPESA_PARTYB_SHORTCODE = config(
    "MPESA_PARTYB_SHORTCODE",
    default=MPESA_PAYBILL_NUMBER or MPESA_SHORTCODE,
)
...
MPESA_IDENTIFIER_TYPE = config("MPESA_IDENTIFIER_TYPE", default="4")
MPESA_RESULT_URL = config("MPESA_RESULT_URL", default="")
MPESA_QUEUE_TIMEOUT_URL = config("MPESA_QUEUE_TIMEOUT_URL", default="")
